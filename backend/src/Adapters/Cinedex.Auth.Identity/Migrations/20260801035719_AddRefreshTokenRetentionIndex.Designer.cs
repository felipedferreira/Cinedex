...
namespace Cinedex.Auth.Identity.Migrations
{
    ...
    [Migration("20260801035719_AddRefreshTokenRetentionIndex")]
    partial class AddRefreshTokenRetentionIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cinedex.Auth.Identity.Entities.RefreshToken", b =>
                {
                    ...
                    b.HasIndex("RevokedAtUtc", "ExpiresAtUtc")
                        .HasDatabaseName("IX_refreshTokens_revokedAtUtc_expiresAtUtc");
