...
The primitives: **Radix-backed, Tailwind-styled, one job each.** The bottom of Cinedex's three component tiers — [`@cinedex/shots`](../shots/README.md) assembles these, [`@cinedex/scenes`](../scenes/README.md) assembles those. A frame is the smallest indivisible unit.
...
flowchart LR
    ...
    IDX -. exported as .-> E1["@cinedex/frames"]
```
