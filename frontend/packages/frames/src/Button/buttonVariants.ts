...
/**
 * The three button looks in the Cinedex UI, and the two scales they come at.
 *
 ...
 *
 * A `ghost` variant and an `sm` size were removed once no screen had reached for
 * either: both were live only in the Storybook grid that demoed them. Add either
 * back the moment a screen needs it — but add it with that call site, not ahead
 * of one.
 *
