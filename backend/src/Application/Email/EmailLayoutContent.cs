...
/// <param name="Heading">The headline, plain text. HTML-encoded before it reaches the markup.</param>
/// <param name="IntroHtml">The explanatory paragraph. Trusted markup — never interpolate user data.</param>
/// <param name="ButtonLabel">The call-to-action label, plain text. HTML-encoded before it reaches the markup.</param>
