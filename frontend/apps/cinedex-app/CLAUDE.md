...
One of seven packages in the `frontend/` npm workspace — see [`../../CLAUDE.md`](../../CLAUDE.md). It consumes [`@cinedex/scenes`](../../packages/scenes/CLAUDE.md) for its auth screens, [`@cinedex/frames`](../../packages/frames/CLAUDE.md) for the odd primitive, and [`@cinedex/theme`](../../packages/theme/CLAUDE.md) for the design system.
