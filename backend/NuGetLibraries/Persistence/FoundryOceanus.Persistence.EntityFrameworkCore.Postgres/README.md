# FoundryOceanus.Persistence.EntityFrameworkCore.Postgres

PostgreSQL support for the FoundryOceanus unit of work: SQLSTATE-aware exception translation and
...
- [`FoundryOceanus.Persistence.Abstractions`](../FoundryOceanus.Persistence.Abstractions/README.md) — the ports.
