...
import { PasswordField } from '@cinedex/compounds';

/**
 * A password field: the label/error wiring of atoms' `Field` around the masked
 ...
 * `onChange`, `autoComplete` and `disabled` all behave as they do on the atom.
 */
const meta = {
  title: 'Compounds/PasswordField',
