...
namespace Cinedex.Persistence.Auth.Identity.Migrations
{
    ...
    [Migration("20260707023805_InitialAuthIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cinedex.Persistence.Auth.Identity.Entities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Cinedex.Persistence.Auth.Identity.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Cinedex.Persistence.Auth.Identity.Entities.RefreshToken", b =>
                {
                    b.HasOne("Cinedex.Persistence.Auth.Identity.Entities.ApplicationUser", null)
                        .WithMany()
